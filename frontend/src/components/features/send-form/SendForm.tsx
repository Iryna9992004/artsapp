...
export default function SendForm() {
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full flex items-center justify-center">
      <form className="w-200 max-w-full  bg-black/80 p-4 flex items-center gap-3">
        <input
          className="rounded-full p-3 flex-1 bg-gray-800 border border-gray-400 placeholder-white text-white outline-none focus:border-white"
